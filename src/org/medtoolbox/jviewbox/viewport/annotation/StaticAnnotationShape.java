...
/**
 * AnnotationShape which is defined entirely in Annotation Space and subject
 * to Annotation Transform. The net effect is a StaticAnnotationShape is
 ...
 */
public class StaticAnnotationShape extends AnnotationShape
{
    // --------------
    // Private fields
    // --------------
    ...
    /**
     * Constructs a StaticAnnotationShape for the specified <code>Shape</code>.
     ...
     */
    public StaticAnnotationShape(Shape shape)
    {
	super(shape);
    }
    ...
    {
	AffineTransform xform = annotationTransform;
